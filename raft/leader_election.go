...
// 			continue
// 		}
// 		go func(serverId int, serverAddr string) {
// 			var reply RequestVoteReply
// 			ok := rf.sendRequestVote(serverAddr, &args, &reply)
// 			if !ok {
// 				// 网络失败等处理
// 				log.Printf("%v: cannot be given a vote by node %v at reply.term=%v\n", rf.SayMeL(), serverId, reply.Term)
// 				return
// 			}
// 			rf.Mu.Lock()
...
// 			// 	votes++
// 			// 	log.Printf("现在得到的票数:%d,现在的人数:%d", votes, len(rf.peers))
// 			// 	if !done && votes > len(rf.peers)/2 {
// 			// 		log.Printf("ready to become leader")
// 			// 		done = true
// 			// 		rf.becomeLeader()
// 			// 		go rf.StartAppendEntries(true)
// 			// 	}
